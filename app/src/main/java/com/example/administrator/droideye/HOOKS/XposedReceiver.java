...
public class XposedReceiver extends BroadcastReceiver {
    ...
    public final static String RESET_ACTION = "com.example.administrator.droideye.RESET_STATS";
    public final static String REFRESH_ACTION = "com.example.administrator.droideye.REFRESH_STATS";
